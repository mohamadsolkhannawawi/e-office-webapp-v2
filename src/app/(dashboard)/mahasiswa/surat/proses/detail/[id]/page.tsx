...
// Ikon kustom untuk EditNote jika ikon bawaan tidak tersedia
const EditNoteIcon = () => (
  <svg
...
export default function DetailSuratProsesPage() {
  ...
  // Gunakan komponen LampiranSurat atau petakan manual jika strukturnya berbeda
  // Di sini kita menggunakan LampiranSurat agar konsisten
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          {application.status === "REVISION" &&
            ...
            revisiHistory && (
              <DetailRevisi
                checker={
                  revisiHistory.role?.name || revisiHistory.actor?.name || "-"
                }
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
            <h2 className="text-lg font-bold text-slate-800 mb-4">Aksi</h2>
            <div className="space-y-3">
              ...
              {/* Edit Mandiri Mahasiswa: hanya untuk status PENDING di step 1 */}
              {canStudentSelfEdit && (
                <Button
