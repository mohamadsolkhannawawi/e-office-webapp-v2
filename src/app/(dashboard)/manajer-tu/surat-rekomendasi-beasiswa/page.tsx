...
async function getManajerTUApplications() {
    try {
...
export default async function ManajerTUSRBPage() {
    const applications = await getManajerTUApplications();

    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <Link href="/manajer-tu">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Daftar pengajuan surat yang perlu diverifikasi.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Total {applications.length} surat menunggu verifikasi
                        Anda.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                                ...
                                applications.map((app: ApplicationSummary) => (
                                    <TableRow key={app.id}>
                                        ...
                                        <TableCell className="text-right">
                                            <Link
                                                href={`/manajer-tu/surat-rekomendasi-beasiswa/${app.id}`}
                                            >
                                                <Button size="sm">
                                                    Verifikasi
                                                </Button>
