...
export default function EditUserPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Perbarui role
      const currentRoles = userData?.userRole.map((ur) => ur.role.id) || [];
    ...
    return (
      <div className="flex h-96 items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Pengguna tidak ditemukan</p>
          <Button
            onClick={() => router.back()}
            className="mt-4"
            variant="outline"
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-500">
                  Terdaftar sejak {formatDate(userData.createdAt)}
                </span>
              </div>
            </div>
          </CardKonten>
            ...
            <CardKonten className="space-y-4">
              <div className="grid gap-4 md:grid-cols-3">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="tahunMasuk"
                    value={formData.mahasiswaData.tahunMasuk}
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        mahasiswaData: {
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input
                    id="tempatLahir"
                    value={formData.mahasiswaData.tempatLahir}
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        mahasiswaData: {
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="tanggalLahir"
                    type="date"
                    value={formData.mahasiswaData.tanggalLahir}
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        mahasiswaData: {
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="mahasiswaDepartemen">Departemen</Label>
                  <Select
                    value={formData.mahasiswaData.departemenId}
                    onValueChange={(value) => {
                      setFormData({
                        ...formData,
                        mahasiswaData: {
                ...
                <div className="space-y-2">
                  <Label htmlFor="mahasiswaProdi">Program Studi</Label>
                  <Select
                    value={formData.mahasiswaData.programStudiId}
                    onValueChange={(value) =>
                      setFormData({
                        ...formData,
                        mahasiswaData: {
                    ...
                    disabled={!formData.mahasiswaData.departemenId}
                  >
                    <SelectTrigger>
        ...
        {!isMahasiswa && userData.pegawai && (
          <Card className="border-gray-200 shadow-sm rounded-3xl">
            ...
            <CardKonten className="space-y-4">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="pegawaiDepartemen">Departemen</Label>
                  <Select
                    value={formData.pegawaiData.departemenId}
                    onValueChange={(value) => {
                      setFormData({
                        ...formData,
                        pegawaiData: {
                ...
                <div className="space-y-2">
                  <Label htmlFor="pegawaiProdi">Program Studi</Label>
                  <Select
                    value={formData.pegawaiData.programStudiId}
                    onValueChange={(value) =>
                      setFormData({
                        ...formData,
                        pegawaiData: {
                    ...
                    disabled={!formData.pegawaiData.departemenId}
                  >
                    <SelectTrigger>
                      <SelectValue placeholder="Pilih Program Studi" />
                    </SelectTrigger>
