...
function KelolaPageKonten() {
  ...
  const [search, setPencarian] = useState(searchParams.get("search") || "");
          ...
          <div className="flex items-center gap-4 sm:gap-5">
            ...
            <div className="flex min-w-0 flex-1 flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <Link href="/super-admin/kelola-pengguna/buat">
                <Button className="bg-undip-blue hover:bg-blue-600 w-full sm:w-auto">
            ...
            <div className="md:col-span-4">
              <div className="flex gap-2">
                <Input
                  ...
                  onKeyDown={(e) => e.key === "Enter" && handlePencarian()}
                  className="flex-1"
                />
            ...
            <div className="grid grid-cols-2 gap-3 md:col-span-4 lg:col-span-2">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="MANAJER_TU">Manajer TU</SelectItem>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Password untuk <strong>{resetDialog.userName}</strong> telah
              ...
              <p className="mt-2 text-sm text-amber-600">
                Catat password ini dan berikan kepada pengguna. Password ini
