...
export default function RoleManagementPage() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-slate-800 mb-2">Kelola Peran</h1>
        ...
        <Card className="border-gray-200 shadow-sm rounded-3xl">
          <CardContent className="pt-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-slate-500">Total Permission</p>
                <p className="text-2xl font-bold text-slate-800">
                  {totalPermissions}
                </p>
              </div>
                      ...
                      <div className="flex min-w-0 flex-col items-start gap-2 sm:flex-row sm:items-center sm:gap-4">
                        ...
                        <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs sm:text-sm text-slate-600">
                          ...
                          <div className="flex items-center gap-1 whitespace-nowrap">
                            ...
                            <span>{role.permissionCount} permission</span>
                          </div>
                        </div>
                      </div>
                      <Button
                        ...
                        className="w-full justify-center hover:bg-gray-200 sm:w-auto sm:justify-start"
                      >
                        {isLoadingDetail ? (
                    ...
                    <div className="p-4 bg-white border-t border-gray-200">
                      <div className="space-y-3">
                        ...
                        <div className="grid gap-2 md:grid-cols-2">
                          {detail.permissions.map((permission, idx) => (
                            <div
