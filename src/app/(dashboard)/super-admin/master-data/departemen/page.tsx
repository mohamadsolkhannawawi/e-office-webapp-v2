                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-3 mt-1">
                                            ...
                                            <span className="text-sm text-slate-500">
                                                {dept.prodiCount} Prodi •{" "}
                                                {dept.mahasiswaCount} Mahasiswa
                                                • {dept.pegawaiCount} Pegawai
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                (selectedDept.prodiCount > 0 ||
                                    ...
                                    <div className="mt-3 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                                        ...
                                        <p className="text-sm text-amber-700 mt-1">
                                            ...
                                            {selectedDept.prodiCount} program
                                            studi, {selectedDept.mahasiswaCount}{" "}
                                            mahasiswa, dan{" "}
                                            {selectedDept.pegawaiCount} pegawai.
                                            Hapus atau pindahkan mereka terlebih
                                            dahulu.
                                        </p>
                                    </div>
                                )}
