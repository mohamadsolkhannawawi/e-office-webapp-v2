    ...
    useEffect(() => {
        ...
        if (filterDepartemenId) {
            filtered = filtered.filter(
                (p) => p.departemenId === filterDepartemenId,
            );
        }
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-3 mt-1">
                                            ...
                                            <span className="text-sm text-slate-500">
                                                {p.mahasiswaCount} Mahasiswa •{" "}
                                                {p.pegawaiCount} Pegawai
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                (selectedProdi.mahasiswaCount > 0 ||
                                    ...
                                    <div className="mt-3 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                                        ...
                                        <p className="text-sm text-amber-700 mt-1">
                                            Program studi ini memiliki{" "}
                                            {selectedProdi.mahasiswaCount}{" "}
                                            mahasiswa dan{" "}
                                            {selectedProdi.pegawaiCount}{" "}
                                            pegawai. Pindahkan mereka terlebih
                                            dahulu.
                                        </p>
                                    </div>
                                )}
