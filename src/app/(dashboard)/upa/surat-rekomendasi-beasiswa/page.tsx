...
async function getUPAApplications() {
    try {
...
export default async function UPASRBPage() {
    const applications = await getUPAApplications();
        ...
        <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Daftar pengajuan yang perlu diberi nomor dan
                            diterbitkan.
                        </p>
                    </div>
                </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Total {applications.length} surat menunggu penerbitan.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <Table>
                                ...
                                applications.map((app: ApplicationSummary) => (
                                    <TableRow key={app.id}>
                                        ...
                                        <TableCell className="text-right">
                                            <Link
                                                href={`/upa/surat-rekomendasi-beasiswa/${app.id}`}
                                            >
                                                <Button size="sm">
                                                    Proses
                                                </Button>
