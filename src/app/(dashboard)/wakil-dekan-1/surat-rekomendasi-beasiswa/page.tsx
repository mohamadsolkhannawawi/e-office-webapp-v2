...
async function getWD1Applications() {
    try {
...
export default async function WD1SRBPage() {
    const applications = await getWD1Applications();

    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <Link href="/wakil-dekan-1">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Daftar pengajuan surat yang perlu ditandatangani.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Total {applications.length} surat menunggu tanda tangan
                        Anda.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                                ...
                                applications.map((app: ApplicationSummary) => (
                                    <TableRow key={app.id}>
                                        ...
                                        <TableCell className="text-right">
                                            <Link
                                                href={`/wakil-dekan-1/surat-rekomendasi-beasiswa/${app.id}`}
                                            >
                                                <Button size="sm">
                                                    Proses
                                                </Button>
