...
export default async function UPAPreviewPage({
    params,
    searchParams,
}: {
    ...
    const previewData = {
        ...
        // Signature URL for UPA to see (Single Source of Truth)
        signatureUrl:
    ...
    return (
        <div className="animate-in fade-in duration-500 pb-10">
            <SuratPreviewContent
                defaultStage={stage || "upa"}
                backUrl={`/upa/surat/surat-rekomendasi-beasiswa/detail/${id}`}
                data={previewData}
                applicationId={id}
            />
        </div>
