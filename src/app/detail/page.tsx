...
import { IdentitasPengaju } from "@/components/features/detail-surat/IdentitasPengaju";
import { DetailSuratPengajuan } from "@/components/features/detail-surat/DetailSuratPengajuan";
import { LampiranSurat } from "@/components/features/detail-surat/LampiranSurat";
import { RiwayatSurat } from "@/components/features/detail-surat/RiwayatSurat";
...
export default function DetailSuratPage() {
  ...
  const handleAjukanSurat = () => {
    // Logic untuk ajukan surat
    console.log("Ajukan surat...");
    // Bisa redirect ke halaman sukses atau detail surat
  };
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6">
          <div className="max-w-7xl mx-auto">
            ...
            {/* Grid Layout: Konten Utama (Kiri) & Riwayat (Kanan) */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* Kolom Kiri: Identitas, Detail, Lampiran */}
