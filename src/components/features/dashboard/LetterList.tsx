...
export function LetterList({
    ...
    return (
        <Card className="border-none shadow-sm overflow-hidden bg-white">
            <div className="p-6 border-b border-slate-50 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                ...
                <div className="flex flex-wrap gap-3 w-full lg:w-auto">
                    ...
                    <Popover>
                        <PopoverTrigger asChild>
                            <Button
                                variant="outline"
                                className="h-10 border-slate-100 text-slate-600 gap-2 whitespace-nowrap"
                            >
                    ...
                    >
                        <SelectTrigger className="w-[180px] h-10 border-slate-100 text-slate-600">
