...
export function AdminActionModals({
  ...
  useEffect(() => {
    if (!isOpen || !iconWrapperRef.current) return;
    ...
    if (type === "revise") {
      animation = el.animate(
        [
          {
            transform: "translateY(10px) scale(0.9) rotate(-18deg)",
            opacity: 0.25,
          },
          {
      ...
      animation = el.animate(
        [
          ...
          {
            transform: "scale(1.06) rotate(6deg) translateX(-4px)",
            opacity: 1,
            offset: 0.5,
          },
          {
        ...
        <div className="p-8">
          <DialogHeader className="mb-6">
            <div className="flex items-center gap-4">
              ...
              >
                {type === "approve" && <Check className="h-6 w-6" />}
                {type === "publish" && <Send className="h-6 w-6" />}
              ...
              <div>
                ...
                <DialogDescription className="text-slate-500 mt-1">
                  ...
                  {type === "reject" && "Tindakan ini tidak dapat dibatalkan."}
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>
          ...
          <div className="space-y-6">
            ...
            {(type === "revise" || type === "reject") && (
              <div className="space-y-3">
                <Label className="text-sm font-bold text-slate-700 uppercase tracking-wider">
                  Alasan {type === "revise" ? "Revisi" : "Penolakan"}{" "}
                ...
                <p className="text-[11px] text-slate-400 flex items-center gap-1">
                  ...
                  Informasi ini akan dikirimkan sebagai notifikasi kepada
                  pengaju.
                </p>
              </div>
            )}
