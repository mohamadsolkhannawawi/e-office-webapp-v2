        ...
        <div className="p-8">
            ...
            <div className="flex flex-col items-center gap-3 text-center sm:flex-row sm:items-center sm:gap-4 sm:text-left">
              ...
              <div>
                ...
                <DialogDescription className="text-slate-500 mt-1 text-sm">
                  Anda dapat mengedit data surat selama belum diproses oleh
                  Supervisor Akademik.
                </DialogDescription>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="space-y-1.5">
                ...
                <ul className="text-sm text-amber-700 space-y-1 list-disc list-inside">
                  <li>
                    Perubahan akan dicatat dalam riwayat surat sebagai{" "}
                    <span className="font-semibold">
                      &ldquo;Revisi oleh Mahasiswa&rdquo;
                    </span>
                  </li>
                  <li>
                    Setelah diedit, surat tetap menunggu verifikasi{" "}
                    <span className="font-semibold">Supervisor Akademik</span>
                  </li>
                  <li>
                    Semua role dapat melihat riwayat ini ketika surat sampai ke
                    tahap mereka
                  </li>
                </ul>
              </div>
          ...
          {scholarshipName && (
            <div className="bg-slate-50 rounded-2xl p-3 mb-6 text-sm">
              ...
              <p className="font-semibold text-slate-800">{scholarshipName}</p>
            </div>
          )}
