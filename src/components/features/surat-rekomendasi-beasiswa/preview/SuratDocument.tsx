        ...
        <div className="w-[800px] bg-white shadow-2xl p-16 min-h-[1100px] flex flex-col font-serif text-slate-900 border border-gray-100">
            ...
            <div className="text-[14px] space-y-6 flex-1 text-justify leading-relaxed">
                ...
                <div className="grid grid-cols-[180px_10px_1fr] gap-x-2 px-10">
                    ...
                    <span>NIM</span> <span>:</span> <span>{finalData.nim}</span>
                ...
                <p>
                    ...
                    sebagai mahasiswa Fakultas Sains dan Matematika Universitas
                    Diponegoro
                </p>
                ...
                <div className="grid grid-cols-[180px_10px_1fr] gap-x-2 px-10">
                    ...
                    <span>IPK</span> <span>:</span> <span>{finalData.ipk}</span>
                    <span>IPS (Semester {finalData.semester})</span>{" "}
                    <span>:</span> <span>{finalData.ips}</span>
                </div>
                ...
                <p>Serta menerangkan bahwa mahasiswa yang bersangkutan:</p>
                ...
                <ul className="pl-10 space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                        <span>-</span>
                        <span>Berstatus aktif kuliah</span>
                    </li>
                    <li className="flex items-start gap-2">
                        <span>-</span>
