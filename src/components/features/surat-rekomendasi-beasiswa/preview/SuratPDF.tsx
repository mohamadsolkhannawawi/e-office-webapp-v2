...
interface SuratPDFProps {
    ...
    showStamp?: boolean;
    data?: any; // Using any for simplicity now, define strict later
}

export const SuratPDF = ({ nomorSurat, showSignature, signaturePath, showStamp, data }: SuratPDFProps) => {
    // Current year logic
            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.headerContainer}>
                    ...
                    <View style={styles.logoContainer}>
                        ...
                        */}
                        <Image src="/assets/undip-logo.png" style={styles.logo} />
                    </View>

                    {/* Center Text */}
                    <View style={styles.centerTextContainer}>
                        <Text style={styles.centerTextMinistry}>KEMENTERIAN PENDIDIKAN TINGGI, SAINS,</Text>
                        <Text style={styles.centerTextMinistry}>DAN TEKNOLOGI</Text>
                        <Text style={styles.centerTextUniversity}>UNIVERSITAS DIPONEGORO</Text>
                        <Text style={styles.centerTextFaculty}>FAKULTAS SAINS DAN MATEMATIKA</Text>
                    </View>

                    {/* Address - Absolute Right */}
                    <View style={styles.addressContainer}>
                        <Text style={styles.addressText}>Jalan Prof. Jacub Rais</Text>
                        <Text style={styles.addressText}>Kampus Universitas Diponegoro</Text>
                        <Text style={styles.addressText}>Tembalang, Semarang Kode Pos 50275</Text>
                        <Text style={styles.addressText}>Telp. (024) 7474754 Fax (024) 7460033</Text>
                        <Text style={styles.addressText}>Laman: www.fsm.undip.ac.id</Text>
                        <Text style={styles.addressText}>Pos-el: fsm@undip.ac.id</Text>
                    </View>
                </View>

                {/* Title */}
                <View style={styles.titleContainer}>
                    <Text style={styles.titleMain}>S U R A T - R E K O M E N D A S I</Text>
                    <Text style={styles.titleNumber}>Nomor: {nomorSurat || "......../UN7.F8.1/KM/....../20..."}</Text>
                </View>

                {/* Body */}
                <View>
                    <Text style={styles.bodyText}>
                        Dekan Fakultas Sains dan Matematika Universitas Diponegoro dengan ini menerangkan :
                    </Text>
                    ...
                    <View style={styles.fieldRow}>
                        <Text style={styles.fieldLabel}>Tempat / Tgl Lahir</Text>
                        <Text style={styles.fieldSeparator}>:</Text>
                        <Text style={styles.fieldValue}>{finalData.tempatLahir}, {finalData.tanggalLahir}</Text>
                    </View>
                    <View style={styles.fieldRow}>
                    ...
                    <Text style={[styles.bodyText, { marginTop: 10 }]}>
                        Pada tahun akademik {finalData.tahunAkademik} terdaftar sebagai mahasiswa Fakultas Sains dan Matematika Universitas Diponegoro
                    </Text>
                    ...
                    <View style={styles.fieldRow}>
                        ...
                        <Text style={styles.fieldSeparator}>:</Text>
                        <Text style={styles.fieldValue}>{finalData.semester}</Text>
                    </View>
                    <View style={styles.fieldRow}>
                    ...
                    <View style={styles.fieldRow}>
                        <Text style={styles.fieldLabel}>IPS (Semester {finalData.semester})</Text>
                        <Text style={styles.fieldSeparator}>:</Text>
                        <Text style={styles.fieldValue}>{finalData.ips}</Text>
                    </View>

                    <Text style={[styles.bodyText, { marginTop: 10 }]}>
                        Surat rekomendasi ini dibuat untuk keperluan : <Text style={{ textDecoration: 'underline' }}>{finalData.keperluan}</Text>
                    </Text>
                    ...
                    <View style={styles.listContainer}>
                        <View style={styles.listItem}>
                            ...
                            <Text style={styles.listItemText}>Tidak sedang mengajukan atau menerima beasiswa dari instansi lain</Text>
                        </View>
                        <View style={styles.listItem}>
                            <Text style={styles.listItemBullet}>-</Text>
                            <Text style={styles.listItemText}>Berstatus aktif kuliah</Text>
                        </View>
                        <View style={styles.listItem}>
                            <Text style={styles.listItemBullet}>-</Text>
                            <Text style={styles.listItemText}>Berkelakuan baik</Text>
                        </View>
                    </View>
                ...
                <View style={styles.signatureContainer}>
                    ...
                    <Text style={styles.signatureText}>Wakil Dekan Akademik dan Kemahasiswaan</Text>
                    ...
                    <View style={styles.signatureImageContainer}>
                        ...
                        {showStamp && (
                             <Image src="/assets/stamp-dummy.png" style={styles.stampImage} />
                        )}
                    </View>

                    <Text style={styles.signatureName}>Prof. Dr. Ngadiwiyana, S.Si., M.Si.</Text>
                    <Text style={styles.signatureNIP}>NIP. 196906201999031002</Text>
                </View>
            </Page>
        </Document>
    );
