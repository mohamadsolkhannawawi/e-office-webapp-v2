  ...
  return (
    <div className="flex flex-col-reverse sm:flex-row justify-between gap-4 mt-8 pt-6 border-t border-gray-200">
      ...
      <Button 
        ...
        className={`bg-white border-gray-300 text-gray-700 hover:bg-gray-50 px-6 h-11 ${currentStep === 1 ? 'opacity-0 pointer-events-none' : ''}`}
      >
        Kembali
      </Button>

      <div className="flex flex-col sm:flex-row gap-3">
        <Button variant="outline" className="text-[#007bff] border-[#007bff]/50 hover:bg-blue-50 h-11 px-6">
          Simpan Draft
        </Button>
